...
/*
* Resets variables so if person wants to play again
* pre: None
* post: all variables get reset to original values
*/
...
/*
* If use presses fire key, this method is called
* pre: None
* post: new bullet object is created and added to entities arraylist, time is taken down
*      to record how long user has before he can shoot again
*/
...
/*
* Adds specific entity that is passed to method into the removeEntities arraylist
* pre: None
* post: entity is added to arraylist to be removed
*/
  public void removeEntity(Entity entity) {
    removeEntities.add(entity);
  }
/*
* Loads specific font file into Font variable
* pre: Font file must be present
* post: Font is loaded with specific font and font size
*/
...
/*
* main game loop that manages everything, draws all the sprites, moves the sprites
* pre: None
* post: All actions and variables are updated
*/
  ...
  private class KeyInputHandler extends KeyAdapter {
     ...
     * pre: A specific key must be pressed
     * post: The apropiate method or bollean varibale is set
     */
     ...
     * pre: A specific key must be released
     * post: The apropiate method or bollean varibale is set
     */
      if (e.getKeyCode() == KeyEvent.VK_LEFT) {
        player1Arrow[0] = false;
